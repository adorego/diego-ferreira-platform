...
- Name: payment-flow.spec.ts >> Flujo de pago (libro, /avanza) >> página /avanza/cancelado tiene opción de reintentar
- Location: tests/payment-flow.spec.ts:39:7
...
Locator: locator('a[href*="/avanza"]')
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 30000ms
  - waiting for locator('a[href*="/avanza"]')
