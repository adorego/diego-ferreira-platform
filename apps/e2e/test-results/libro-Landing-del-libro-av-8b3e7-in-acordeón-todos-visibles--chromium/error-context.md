...
- Name: libro.spec.ts >> Landing del libro (/avanza) >> los 15 capítulos están listados (sin acordeón, todos visibles)
- Location: tests/libro.spec.ts:35:7
...
Locator: getByText('No nací fuerte', { exact: true }).first()
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 30000ms
  - waiting for getByText('No nací fuerte', { exact: true }).first()
